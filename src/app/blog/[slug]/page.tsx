          ...
          <article className="max-w-3xl mx-auto">
            ...
            <div
              className="blog-content prose prose-lg dark:prose-invert max-w-none
                ...
                prose-p:text-[var(--text)] prose-p:opacity-90 prose-p:leading-8 prose-p:my-8
                ...
                prose-blockquote:border-l-4 prose-blockquote:border-[var(--accent)] prose-blockquote:pl-8 prose-blockquote:py-4 prose-blockquote:my-12 prose-blockquote:bg-[var(--bg-elevated)] prose-blockquote:shadow-md prose-blockquote:rounded-r-2xl
                prose-blockquote:text-[var(--text)] prose-blockquote:not-italic prose-blockquote:text-2xl prose-blockquote:font-medium
