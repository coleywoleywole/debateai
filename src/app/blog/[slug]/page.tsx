          ...
          <article className="max-w-3xl mx-auto">
            ...
            <div
              className="blog-content prose prose-lg dark:prose-invert max-w-none
                ...
                prose-h2:mt-12 prose-h2:mb-6 prose-h2:pb-4 prose-h2:border-b prose-h2:border-[var(--border)]/50 prose-h2:text-3xl prose-h2:sm:text-4xl prose-h2:leading-tight
                prose-h3:mt-10 prose-h3:mb-4 prose-h3:text-2xl prose-h3:sm:text-3xl
                prose-p:text-[var(--text)] prose-p:opacity-90 prose-p:leading-relaxed prose-p:my-6 prose-p:text-base sm:prose-p:text-lg
                ...
                prose-blockquote:border-l-4 prose-blockquote:border-[var(--accent)] prose-blockquote:pl-8 prose-blockquote:py-4 prose-blockquote:my-8 prose-blockquote:bg-[var(--accent)]/[0.03] prose-blockquote:rounded-r-2xl
                ...
                prose-li:text-[var(--text)] prose-li:opacity-90 prose-li:leading-relaxed prose-li:text-base sm:prose-li:text-lg
                prose-img:rounded-3xl prose-img:my-10 prose-img:shadow-2xl
                prose-hr:my-10 prose-hr:border-[var(--border)]/50 prose-hr:border-t
                [&>p:first-of-type]:text-lg [&>p:first-of-type]:sm:text-xl [&>p:first-of-type]:font-medium [&>p:first-of-type]:text-[var(--text)] [&>p:first-of-type]:opacity-100 [&>p:first-of-type]:leading-relaxed [&>p:first-of-type]:mb-10"
