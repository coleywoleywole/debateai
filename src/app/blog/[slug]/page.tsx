          ...
          <article className="max-w-3xl mx-auto">
            ...
            <div
              className="blog-content prose prose-lg dark:prose-invert max-w-none
                ...
                prose-h2:mt-20 prose-h2:mb-10 prose-h2:pb-4 prose-h2:border-b prose-h2:border-[var(--border)]/50 prose-h2:text-3xl prose-h2:sm:text-4xl prose-h2:leading-tight
                prose-h3:mt-16 prose-h3:mb-8 prose-h3:text-2xl prose-h3:sm:text-3xl
                prose-p:text-[var(--text)] prose-p:opacity-90 prose-p:leading-relaxed prose-p:my-10 prose-p:text-lg
                ...
                prose-code:text-[var(--accent)] prose-code:bg-[var(--bg-sunken)] prose-code:px-2 prose-code:py-1 prose-code:rounded-lg prose-code:text-sm prose-code:before:content-none prose-code:after:content-none
                prose-blockquote:border-l-4 prose-blockquote:border-[var(--accent)] prose-blockquote:pl-8 prose-blockquote:py-4 prose-blockquote:my-12 prose-blockquote:bg-[var(--accent)]/[0.03] prose-blockquote:rounded-r-2xl
                prose-blockquote:text-[var(--text)] prose-blockquote:not-italic prose-blockquote:text-xl prose-blockquote:sm:text-2xl prose-blockquote:font-medium
                prose-ul:my-12 prose-ol:my-12 prose-li:my-6
                prose-li:text-[var(--text)] prose-li:opacity-90 prose-li:leading-relaxed prose-li:text-lg
                prose-img:rounded-3xl prose-img:my-12 prose-img:shadow-2xl
                prose-hr:my-16 prose-hr:border-[var(--border)]/50 prose-hr:border-t
                [&>p:first-of-type]:text-xl [&>p:first-of-type]:sm:text-2xl [&>p:first-of-type]:font-medium [&>p:first-of-type]:text-[var(--text)] [&>p:first-of-type]:opacity-100 [&>p:first-of-type]:leading-normal [&>p:first-of-type]:mb-16"
